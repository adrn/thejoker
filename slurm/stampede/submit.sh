...
#SBATCH -n 257                   # total number of mpi tasks requested
...
# ibrun python run-sampler.py -v --id='2M00110648+6609349' --mpi -n 2**20
# ibrun python run-sampler.py -v --id='2M00344509+8512058' --mpi -n 2**20
