...
points).
Figures~\ref{fig:exp2-rv-1}--\ref{fig:exp2-rv-2} show the data and orbits
...
circles, and the removed measurements are plotted as dark grey X's.
The number of measurements used and the number of surviving samples are
...
\end{center}
\caption{%
In all panels, black points show ... dark grey X's show deleted data points \apogee\ radial velocity measurements plotted against
Barycentric Modified Julian Date (BMJD) of the observations.
Grey curves show orbits compute from 512 samples from the posterior pdf for
these data.
Note that several qualitatively different orbital solutions are found over a
