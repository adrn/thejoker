...
As the phase coverage increases and number of observations grow, the posterior
pdf over orbital parameters will tend to become less multi-modal and eventually
will be unimodal.
When this happens, \samplername\ becomes very inefficient and will return very few samples (as few as one)
