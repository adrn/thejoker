...
function).
% Methods
The six orbital parameters can be split into the four non-linear parameters
(period, eccentricity, argument of pericenter, phase) and two linear parameters
(velocity amplitude and bayrcenter velocity).
We capitalize on this structure and build a variant of Simple Monte Carlo
...
method.
The primary innovations we bring is a separation of the parameters
...
These posterior pdfs make look like a mess, but they would contribute
...
content.
That is beyond the scope of this \documentname, but is not beyond
the scope of our ambition.
