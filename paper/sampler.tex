...
\begin{equation}
  v(t) = v_0 + K\,[\cos(\omega + f) + e\,\cos\omega]
\end{equation}
...
The unmarginalized likelihood function would be
\begin{equation}
...
The function $v(t)$ is controlled by four nonlinear parameters and two linear parameters...
