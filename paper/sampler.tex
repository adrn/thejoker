...
\figname s~\ref{fig:exp3-rv} shows the simulated data and orbits computed from
posterior samplings.
Starting from the top of \figname~\ref{fig:exp3-rv} with the full set of 11
...
shown in the right panels of \figname~\ref{fig:exp3-rv}.
...
\begin{figure*}[p]
\begin{center}
\includegraphics[width=\textwidth]{figures/exp3-rv-curves.pdf}
\end{center}
\caption{%
...
\figname~\ref{fig:exp4-rv} shows radial velocity data for the star (black
...
sampling step.
Over-plotted as grey lines on \figname~\ref{fig:exp4-rv} are 256 orbits computed
from these samples.
...
\figname~\ref{fig:exp4-corner} shows projections of all posterior samples in
...
\begin{figure*}[p]
\begin{center}
\includegraphics[width=\textwidth]{figures/exp4-corner.pdf}
\end{center}
\caption{%
...
\figname~\ref{fig:exp3-rv} is that the posterior pdf collapses significantly
