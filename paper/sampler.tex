...
impressive Proxima b discovery; \citealt{Anglada-Escude:2016}).
...
All these caveats noted~-- and despite the flexibility of the noise
model introduced with the jitter parameter $s^2$~-- \emph{by far} the
worst assumption made by \samplername\ is that the noise is Gaussian:
