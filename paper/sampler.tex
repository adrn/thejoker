...
We draw 128 of these at random and show these in \figname~\ref{fig:exp2-rv}.
From these orbits, it appears that there are at least a few distinct period
modes and a wide variety of eccentricities.

\figname~\ref{fig:exp2-corner} shows projections of all 23,584 posterior samples
in different parameter combinations.
...
Grey curves show orbits compute from 128 samples from the posterior pdf for
these data.
