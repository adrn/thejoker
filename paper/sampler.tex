...
In DR13, this target has 30 visit spectra; we remove 11 data points at random so
that we begin with 19 observtions
...
Starting from the top of Figure~\ref{fig:exp2-rv-1} with the full set of 19
...
\begin{figure*}[p]
\begin{center}
\includegraphics[height=0.9\textheight]{figures/exp2-rv-curves-0.pdf}
\end{center}
\caption{%
...
\begin{figure*}[p]
\begin{center}
\includegraphics[height=0.9\textheight]{figures/exp2-rv-curves-1.pdf}
\end{center}
\caption{%
...
Stuff about corner plots...

\begin{figure*}[p]
\begin{center}
\includegraphics[height=0.9\textheight]{figures/exp2-corner-0.pdf}
\end{center}
\caption{%
Similar to Figure~\ref{fig:exp1-rv}, in all panels, black points show \apogee\
radial velocity measurements used to generate samples from the posterior pdf
...
\begin{figure*}[p]
\begin{center}
\includegraphics[height=0.9\textheight]{figures/exp2-corner-1.pdf}
\end{center}
\caption{%
