...
for data point $n$.
Note that the form of this likelihood function is fully specified {\color{red} right?}
 by the assumptions, given above.
...
all of the parameter space encompassed by the prior distribution: even a few
radial velocity measurements are manifestly very informative.
{\color{red} Make sure you feel comfortable about this statement.}
...
Less precise data, compared to the radial velocityamplitude,
...
{\color{red} HWR: the original sentence talks about `fixed jitter', and the `intrinsic variability'
of the system. Are these concepts different?}
...
{\color{red} HWR: Here Troup et al will say ``we told you so!'' To which extent are they right?}
