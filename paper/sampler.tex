...
XX$ (sometimes referred to as the Rayleigh frequency) corresponding to period
differences of $\Delta P \approx XX$ APW TODO.
...
But nonetheless the vast majority of prior pdf samples have been eliminated, and
...
Many prior samples are needed when (a) many posterior pdf samples are needed for
hierarchical inference, or (b) the data are of intermediate quality (the
definition of which is left intentionally vague).
