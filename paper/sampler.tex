...
sampling for orbital parameters given sparse or noisy radial-velocity
...
a likelihood marginalized over the linear parameters.
With sparse or uninformative data, the sampling obtained by the rejection
sampling is generally multimodal and dense.
With very informative data, the sampling becomes effectively unimodal but too
sparse; in this case, we therefore follow the rejection sampling with standard
MCMC.
% Results
...
nonlinear subspace, aiding computational feasibility.
